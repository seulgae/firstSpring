...
<head>
    <meta charset="UTF-8">
    <title>Seulgae</title>
    <link rel="stylesheet" href="<c:url value='/css/portfolio.css'/>">
...
<div id="slide">
    <div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            <c:forEach var="cnt" begin="1" end="24" >
            <!-- Slides -->
            <div class="swiper-slide"><img src="<c:url value='/img/portfolio/${cnt}.jpg'/>" width="1500px" height="800px"></div>
            </c:forEach>
        </div>

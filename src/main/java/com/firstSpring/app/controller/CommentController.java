...
public class CommentController {
    ...
    // 댓글을 수정하는 메서드
    @PatchMapping("/comments/{cno}") // /app/comments?bno=3395 POST
    ...
    // 댓글을 등록하는 메서드
    @PostMapping("/comments") // /app/comments?bno=3395 POST
    ...
    // 지정된 댓글을 삭제하는 메서드
    @DeleteMapping("/comments/{cno}")  // /comments/1?bno=3395 <-- 삭제할 댓글 번호
